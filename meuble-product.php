    ...
    <main>
        ...
        <section class="lien_pages">
            <ul class="liste_lien-page container">
                ...
                <li><span class="lien-page">Meuble</span></li>        
            </ul>
        </section>

        <!--===============Nos Produit===============-->
        <section class="produit section container">
            <h3 class="section__title"><span>Nos</span> Meubles</h3>
            ...
            <div class="produit_container section grid">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<p>Aucun produit trouvé dans la catégorie Meubles.</p>";
                }
                ?>
            </div>
        </section>
