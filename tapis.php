...
session_start();
include 'config.php';
include 'quantity.php'; // Ceci permet de compter leq quantité de produit dans le panier
    ...
    <main>
        ...
        <section class="lien_pages">
            <ul class="liste_lien-page container">
                ...
                <li><span class="lien-page">Tapis</span></li>        
            </ul>
        </section>

        <!--===============Nos Produit===============-->
        <section class="produit section container">
            <h3 class="section__title"><span>Nos</span> Tapis</h3>
            ...
            <div class="produit_container section grid">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<p>Aucun produit trouvé dans la catégorie Tapis.</p>";
                }
                ?>
            </div>
        </section>
